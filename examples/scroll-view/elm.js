...
var $author$project$Main$init = {selected: $elm$core$Maybe$Nothing};
...
var $author$project$Main$colors = _List_fromArray(
	['#FF6B6B', '#4ECDC4', '#45B7D1', '#96CEB4', '#FFEAA7', '#DDA0DD', '#98D8C8', '#F7DC6F', '#BB8FCE', '#85C1E9', '#F0B27A', '#82E0AA', '#F1948A', '#85929E', '#D7BDE2', '#A3E4D7', '#FAD7A0', '#AED6F1', '#D5DBDB', '#EDBB99']);
...
var $author$project$Main$viewCard = F3(
	function (selected, idx, colorHex) {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Main$Select(idx)),
					...
					$lynxjs_elm$ui$Lynx$Attributes$borderRadius(12),
					$lynxjs_elm$ui$Lynx$Attributes$backgroundColor('#ffffff'),
					$lynxjs_elm$ui$Lynx$Attributes$borderWidth(
					isSelected ? 2 : 0),
					$lynxjs_elm$ui$Lynx$Attributes$borderColor(colorHex),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$lynxjs_elm$ui$Lynx$Attributes$width(48),
							$lynxjs_elm$ui$Lynx$Attributes$height(48),
							$lynxjs_elm$ui$Lynx$Attributes$borderRadius(12),
							$lynxjs_elm$ui$Lynx$Attributes$backgroundColor(colorHex),
							$lynxjs_elm$ui$Lynx$Attributes$marginRight(16)
						]),
					_List_Nil),
					A2(
					$lynxjs_elm$ui$Lynx$view,
						...
						[
							...
							_List_fromArray(
								[
									...
									$lynxjs_elm$ui$Lynx$Attributes$color('#2C3E50')
								]),
							_List_fromArray(
								[
									$lynxjs_elm$ui$Lynx$textContent(
									'Color #' + $elm$core$String$fromInt(idx + 1))
								])),
							A2(
							$lynxjs_elm$ui$Lynx$text,
							_List_fromArray(
								[
									...
									$lynxjs_elm$ui$Lynx$Attributes$color('#7F8C8D'),
									$lynxjs_elm$ui$Lynx$Attributes$marginTop(2)
								]),
							_List_fromArray(
								[
									$lynxjs_elm$ui$Lynx$textContent(colorHex)
								]))
						])),
					isSelected ? A2(
					$lynxjs_elm$ui$Lynx$text,
					_List_fromArray(
						[
							...
							$lynxjs_elm$ui$Lynx$Attributes$color(colorHex)
						]),
					_List_fromArray(
						[
							$lynxjs_elm$ui$Lynx$textContent('●')
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$lynxjs_elm$ui$Lynx$Attributes$backgroundColor('#2C3E50'),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$lynxjs_elm$ui$Lynx$Attributes$fontSize(22),
								$lynxjs_elm$ui$Lynx$Attributes$fontWeight($lynxjs_elm$ui$Lynx$Attributes$Bold),
								$lynxjs_elm$ui$Lynx$Attributes$color('#ffffff')
							]),
						_List_fromArray(
							[
								$lynxjs_elm$ui$Lynx$textContent('Color Palette')
							])),
						A2(
						$lynxjs_elm$ui$Lynx$text,
						_List_fromArray(
							[
								...
								$lynxjs_elm$ui$Lynx$Attributes$color('#95A5A6'),
								$lynxjs_elm$ui$Lynx$Attributes$marginTop(4)
							]),
						_List_fromArray(
							[
								$lynxjs_elm$ui$Lynx$textContent('Tap a color to select it')
							]))
					])),
				A2(
				...
				A2(
					...
					$author$project$Main$viewCard(model.selected),
					$author$project$Main$colors)),
				A2(
				$lynxjs_elm$ui$Lynx$view,
				_List_fromArray(
					[
						$lynxjs_elm$ui$Lynx$Attributes$backgroundColor('#34495E'),
					...
					[
						...
						if (_v0.$ === 'Nothing') {
							return A2(
								...
								_List_fromArray(
									[
										$lynxjs_elm$ui$Lynx$textContent('No color selected')
									]));
						} else {
							var idx = _v0.a;
							var colorHex = A2(
								...
								'#000000',
								$elm$core$List$head(
									A2($elm$core$List$drop, idx, $author$project$Main$colors)));
							return A2(
								$lynxjs_elm$ui$Lynx$view,
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$lynxjs_elm$ui$Lynx$Attributes$width(20),
												$lynxjs_elm$ui$Lynx$Attributes$height(20),
												$lynxjs_elm$ui$Lynx$Attributes$borderRadius(10),
												$lynxjs_elm$ui$Lynx$Attributes$backgroundColor(colorHex),
										...
										_List_fromArray(
											[
												$lynxjs_elm$ui$Lynx$textContent('Selected: ' + colorHex)
											]))
									]));
						}
					}()
