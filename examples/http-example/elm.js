...
var $lynxjs_elm$http$Http$expectString = function (toMsg) {
	return A2(
		$lynxjs_elm$http$Http$expectStringResponse,
		toMsg,
		$lynxjs_elm$http$Http$resolve($elm$core$Result$Ok));
};
...
var $author$project$Main$fetchQuote = $lynxjs_elm$http$Http$get(
	{
		expect: $lynxjs_elm$http$Http$expectString($author$project$Main$GotQuote),
		url: 'https://api.quotable.io/quotes/random'
	});
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{status: $author$project$Main$Loading},
		$author$project$Main$fetchQuote);
};
			...
			if (result.$ === 'Ok') {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							status: $author$project$Main$Success(body)
						}),
...
var $author$project$Main$FetchQuote = {$: 'FetchQuote'};
...
var $lynxjs_elm$ui$Lynx$Attributes$alignItems = $lynxjs_elm$ui$Lynx$Attributes$style('alignItems');
var $lynxjs_elm$ui$Lynx$Attributes$color = $lynxjs_elm$ui$Lynx$Attributes$style('color');
var $lynxjs_elm$ui$Lynx$Attributes$flexDirection = $lynxjs_elm$ui$Lynx$Attributes$style('flexDirection');
...
var $author$project$Main$statusText = function (status) {
	switch (status.$) {
		...
		case 'Success':
			var body = status.a;
			return A2($elm$core$String$left, 200, body);
		default:
			var err = status.a;
			return err;
	}
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$lynxjs_elm$ui$Lynx$Attributes$flexDirection('column'),
				$lynxjs_elm$ui$Lynx$Attributes$alignItems('center')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$lynxjs_elm$ui$Lynx$Attributes$fontSize(24),
						$lynxjs_elm$ui$Lynx$Attributes$padding(10)
					]),
				_List_fromArray(
					[
						$lynxjs_elm$ui$Lynx$textContent('HTTP Example')
					])),
				A2(
				$lynxjs_elm$ui$Lynx$view,
				_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Main$statusColor(model.status))
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						$lynxjs_elm$ui$Lynx$Events$onTap($author$project$Main$FetchQuote),
						$lynxjs_elm$ui$Lynx$Attributes$padding(10)
					]),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								$lynxjs_elm$ui$Lynx$Attributes$color('#007AFF')
							]),
						_List_fromArray(
							[
								$lynxjs_elm$ui$Lynx$textContent('Fetch New Quote')
							]))
					]))
			]));
};
var $author$project$Main$main = $lynxjs_elm$browser$Browser$element(
	{
		...
		view: $author$project$Main$view_
	});
