...
var $author$project$Main$main = A3(
	$lynxjs_elm$virtual_dom$VirtualDom$node,
	'view',
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$lynxjs_elm$virtual_dom$VirtualDom$text('Hello from Elm on LynxJS!')
				]))
		]));
_Platform_export({'Main':{'init':_VirtualDom_init($author$project$Main$main)(0)(0)}});}(globalThis));