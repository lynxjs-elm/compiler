...
var $author$project$Main$init = {
	...
	items: _List_fromArray(
		[
			{done: true, id: 1, text: 'Learn Elm'},
			{done: false, id: 2, text: 'Build a LynxJS app'},
			{done: false, id: 3, text: 'Ship to production'}
		]),
	nextId: 4
};
...
var $lynxjs_elm$browser$Browser$sandbox = function (impl) {
		...
		switch (msg.$) {
				...
				return _Utils_update(
					model,
					{
						items: A2(
							...
							function (item) {
								return !_Utils_eq(item.id, targetId);
							},
							model.items)
					});
			case 'UpdateDraft':
			...
			default:
				return $elm$core$String$isEmpty(
					$elm$core$String$trim(model.draft)) ? model : _Utils_update(
					model,
					{
						draft: '',
						items: _Utils_ap(
							...
							_List_fromArray(
								[
									{done: false, id: model.nextId, text: model.draft}
								])),
...
var $author$project$Main$summaryText = function (items) {
	var total = $elm$core$List$length(items);
	var done = $elm$core$List$length(
		A2(
			...
			items));
	return $elm$core$String$fromInt(done) + ('/' + ($elm$core$String$fromInt(total) + ' completed'));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$lynxjs_elm$ui$Lynx$Attributes$borderColor('#eeeeee')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Main$Toggle(item.id)),
						$lynxjs_elm$ui$Lynx$Attributes$width(28),
						$lynxjs_elm$ui$Lynx$Attributes$height(28),
						$lynxjs_elm$ui$Lynx$Attributes$borderRadius(14),
						$lynxjs_elm$ui$Lynx$Attributes$borderWidth(2),
						$lynxjs_elm$ui$Lynx$Attributes$borderColor(
						item.done ? '#4a90d9' : '#cccccc'),
						$lynxjs_elm$ui$Lynx$Attributes$backgroundColor(
						item.done ? '#4a90d9' : '#ffffff'),
						$lynxjs_elm$ui$Lynx$Attributes$alignItems($lynxjs_elm$ui$Lynx$Attributes$Center),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							...
							])) : A2($lynxjs_elm$ui$Lynx$text, _List_Nil, _List_Nil)
					])),
				A2(
				$lynxjs_elm$ui$Lynx$text,
				_List_fromArray(
					[
						...
						$lynxjs_elm$ui$Lynx$Attributes$color(
						item.done ? '#aaaaaa' : '#333333')
					]),
				_List_fromArray(
					[
						$lynxjs_elm$ui$Lynx$textContent(item.text)
					])),
				A2(
				$lynxjs_elm$ui$Lynx$view,
				_List_fromArray(
					[
						$lynxjs_elm$ui$Lynx$Events$onTap(
						$author$project$Main$Remove(item.id)),
						$lynxjs_elm$ui$Lynx$Attributes$paddingLeft(8),
						$lynxjs_elm$ui$Lynx$Attributes$paddingRight(8)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$lynxjs_elm$ui$Lynx$Attributes$color('#cc0000')
							]),
						_List_fromArray(
							[
								$lynxjs_elm$ui$Lynx$textContent('✕')
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$lynxjs_elm$ui$Lynx$Attributes$padding(20),
				$lynxjs_elm$ui$Lynx$Attributes$flex(1)
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$lynxjs_elm$ui$Lynx$Attributes$marginBottom(16)
					]),
				_List_fromArray(
					[
						$lynxjs_elm$ui$Lynx$textContent('Todo List')
					])),
				A2(
				$lynxjs_elm$ui$Lynx$view,
				_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								$lynxjs_elm$ui$Lynx$Attributes$placeholder('What needs to be done?'),
								$lynxjs_elm$ui$Lynx$Attributes$flex(1),
								$lynxjs_elm$ui$Lynx$Attributes$height(44),
								$lynxjs_elm$ui$Lynx$Attributes$fontSize(16),
								$lynxjs_elm$ui$Lynx$Attributes$borderWidth(1),
								$lynxjs_elm$ui$Lynx$Attributes$borderColor('#cccccc'),
						...
						_List_fromArray(
							[
								$lynxjs_elm$ui$Lynx$Events$onTap($author$project$Main$AddItem),
								$lynxjs_elm$ui$Lynx$Attributes$backgroundColor('#4a90d9'),
								$lynxjs_elm$ui$Lynx$Attributes$borderRadius(8),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$lynxjs_elm$ui$Lynx$textContent('Add')
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						$lynxjs_elm$ui$Lynx$Attributes$fontSize(14),
						$lynxjs_elm$ui$Lynx$Attributes$color('#888888'),
						$lynxjs_elm$ui$Lynx$Attributes$marginBottom(12)
					]),
				_List_fromArray(
					[
						$lynxjs_elm$ui$Lynx$textContent(
						$author$project$Main$summaryText(model.items))
					])),
				A2(
				...
				A2($elm$core$List$map, $author$project$Main$viewItem, model.items))
			]));
};
var $author$project$Main$main = $lynxjs_elm$browser$Browser$sandbox(
