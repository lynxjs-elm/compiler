		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$lynxjs_elm$ui$Lynx$Attributes$paddingLeft(24),
					$lynxjs_elm$ui$Lynx$Attributes$paddingRight(24)
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$lynxjs_elm$ui$Lynx$textContent(label)
						]))
				]));
	});
...
var $lynxjs_elm$ui$Lynx$Attributes$justifyContent = $lynxjs_elm$ui$Lynx$Attributes$style('justifyContent');
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$lynxjs_elm$ui$Lynx$Attributes$justifyContent('center'),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$lynxjs_elm$ui$Lynx$Attributes$flexDirection('row'),
						$lynxjs_elm$ui$Lynx$Attributes$alignItems('center')
					]),
				_List_fromArray(
					[
						A2($author$project$Main$button, $author$project$Main$Decrement, '-'),
						A2(
						$lynxjs_elm$ui$Lynx$text,
						_List_fromArray(
							[
								$lynxjs_elm$ui$Lynx$Attributes$fontSize(32),
								$lynxjs_elm$ui$Lynx$Attributes$marginLeft(20),
								$lynxjs_elm$ui$Lynx$Attributes$marginRight(20)
							]),
						_List_fromArray(
							[
						...
						A2($author$project$Main$button, $author$project$Main$Increment, '+')
					]))
			]));
};
